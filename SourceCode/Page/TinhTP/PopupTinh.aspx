<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PopupTinh.aspx.vb" Inherits="Page_TinhTP_PopupTinh" %>

<%@ Register src="../../Control/TinhTP/PopupTinh.ascx" tagname="PopupTinh" tagprefix="uc1" %>
...
<body>
    ...
    <div>
        ...
        <uc1:PopupTinh ID="PopupTinh1" runat="server" />
