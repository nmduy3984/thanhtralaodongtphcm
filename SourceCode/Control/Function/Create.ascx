<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Create.ascx.vb" Inherits="Control_Function_Create" %>
...
<asp:UpdatePanel ID="uplYtgchanthuong" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    <asp:Label ID="Label3" runat="server" Text="THÊM MENU" /></h3>
            </div>
            ...
            <div class="DivRow">
                ...
                <div class="DivTextBox">
                    <cc1:ValidationTextBox ID="txtUrl" CssClass="TextBox" runat="server" ></cc1:ValidationTextBox>
                </div>
            </div>
            <div class="DivRow">
                <div class="DivLabel">
                ...
                <div class="DivTextBox">
                    <cc1:ValidationTextBox ID="txtSort" CssClass="TextBox" runat="server" DataType="integer"></cc1:ValidationTextBox>
                </div>
            </div>
            <div class="DivRow">
                <div class="DivLabel">
