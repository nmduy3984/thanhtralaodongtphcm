<%@ Control Language="VB" AutoEventWireup="false" CodeFile="List.ascx.vb" Inherits="Control_DanhMucTrichDan_List" %>
...
<asp:UpdatePanel ID="uplDonvikinhtehcsn" runat="server">
    <ContentTemplate>
        ...
        <div class="HeadTitle">
            <h3>
                QUẢN LÝ TRÍCH DẪN</h3>
        </div>
        <div class="SubjectTitle">
            Lọc theo tên trích dẫn:
        ...
        <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText='Nội dung trích dẫn'>
                    <ItemTemplate>
                        <asp:HyperLink ID="hplNDTrichDan" runat="server"></asp:HyperLink>
                    </ItemTemplate>
