<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Create.ascx.vb" Inherits="Control_DanhMucTrichDan_Create" %>
...
<asp:UpdatePanel ID="uplYtgchanthuong" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    <asp:Label ID="Label3" runat="server" Text="THÊM TRÍCH DẪN" /></h3>
            </div>
            ...
            <div class="DivRow">
                ...
                <div class="DivTextBox">
                    <cc1:ValidationTextBox ID="txtNDTrichDan" CssClass="TextBox SmallTextarea" 
                        runat="server" DataType="required" Height="80px" TextMode="MultiLine"
