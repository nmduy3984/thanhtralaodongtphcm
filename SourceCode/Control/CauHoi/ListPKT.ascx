<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ListPKT.ascx.vb" Inherits="Control_CauHoi_ListPKT" %>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="lnkbtnDelete" Text="Xóa" runat="server" OnClick="lnkbtnDelete_Click"
                            CausesValidation='False'></asp:LinkButton>&nbsp;|&nbsp;<asp:LinkButton ID="lnkTaoPhieu"
                                Text="Kế thừa" runat="server" CausesValidation='False' OnClick="lnkTaoPhieu_Click"></asp:LinkButton>
                    </ItemTemplate>
