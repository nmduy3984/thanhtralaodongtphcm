<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ContentEditor.ascx.vb"
    Inherits="Control_CauHoi_ContentEditor" %>
<div>
                    ...
                    <div class="tabs_manage">
                        <ul>
                            ...
                            <li id="li10" runat="server">
                                <asp:LinkButton ID="lbtCau10" CausesValidation="false" runat="server" ToolTip="Lao động là người nước ngoài"><span>Mục 10</span></asp:LinkButton></li>
                            ...
                            <%--<%  If Not Request.PhysicalPath.Contains("PhieuKiemTra") Then
                            %>
                            <li id="li13" runat="server">
                                <asp:LinkButton ID="lbtYKienDN" CausesValidation="false" runat="server" ToolTip="Ý Kiến của doanh nghiệp"><span>Ý kiến Doanh Nghiệp </span></asp:LinkButton></li>
                            <%
                            End If%>--%>
                        </ul>
                    </div>
