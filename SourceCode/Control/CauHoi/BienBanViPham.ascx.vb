        ...
        Try
            ...
            Using document As DocX = DocX.Load(FolderPath & "\BBVP_Template.docx")
                ...
                Using data As New ThanhTraLaoDongEntities
                    ...
                    'Lấy thông tin khu công nghiệp nếu có
                    Dim kcn As New KhuCongNghiep
                    Dim tenKhuCongNghiep = ""
                    If Not IsNothing(dn) Then
                        If dn.KhuCongNghiepId > 0 Then
                            kcn = (From q In data.KhuCongNghieps Where q.KhuCongNghiepId = dn.KhuCongNghiepId).SingleOrDefault
                            If Not IsNothing(kcn) Then
                                tenKhuCongNghiep = kcn.TenKhuCongNghiep
                            End If
                        End If
                    End If
                    ''''Cơ quan ban hành
                    ...
                    For i As Integer = 1 To 5
                        ...
                        Select Case i
                            ...
                            Case 2
                                pNewDN.Append("Trụ sở chính: " & dn.TruSoChinh & " " & tenKhuCongNghiep & ", " & dn.TenHuyen & ", " & dn.TenTinh)
                            Case 3
