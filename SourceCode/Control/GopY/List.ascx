<%@ Control Language="VB" AutoEventWireup="false" CodeFile="List.ascx.vb" Inherits="Control_GopY_List" %>
...
<asp:UpdatePanel ID="uplDonvikinhtehcsn" runat="server">
    <ContentTemplate>
        ...
        <div class="SubjectTitle" style="padding-bottom:20px">
            Lọc theo nội dung góp ý:
        ...
        <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
            ...
            <Columns>
                ...
                <asp:BoundField DataField='NguoiTao' HeaderText='Người góp ý'>
                    <ItemStyle Width='8%' />
                </asp:BoundField>
