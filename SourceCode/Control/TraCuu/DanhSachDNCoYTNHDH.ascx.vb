...
Partial Class Control_TraCuu_rptDanhSachDNCoYTNHDH
...
#Region "PRIVATE EVENT FOR CONTROL"
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1 _
        ...
        Using data As New ThanhTraLaoDongEntities
            ...
            'strYearTo = IIf(strYearTo = 0, 3999, strYearTo)
            ...
            Dim p = data.uspDanhSachDNCoYTNHDH(strTinh, strYearFrom, strYearTo, strLHSX, strCoNHDH, strCoTNLD, iPage, intPag_Size).ToList()
            'Tong so ban ghi
            If p.Count > 1 Then
                rowCount = p.Count
