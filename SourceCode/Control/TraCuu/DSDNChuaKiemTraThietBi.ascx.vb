...
Partial Class Control_TraCuu_DSDNChuaKiemTraThietBi
...
#Region "PRIVATE EVENT FOR CONTROL"
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1 _
                            ...
                            , Optional ByVal strToDate As Date = #1/1/9999#)
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim p = data.uspTraCuuDSDNChuaKiemTraThietBi(strTinh, strFromDate, strToDate, iPage, intPag_Size).ToList()
            'Tong so ban ghi
