<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DSDNChuaKiemTraThietBi.ascx.vb" Inherits="Control_TraCuu_DSDNChuaKiemTraThietBi" %>
...
<asp:UpdatePanel ID="uplDailyDebt" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>                    
                    <asp:Label ID="lblReportName" runat="server" Text="Danh sách doanh nghiệp chưa kiểm tra thiết bị" />
                </h3>
            </div>
            ...
            <div id="SearchCondition" class="Div-Center">
                ...
                <div class="DivRow">
                    <div class="DivLabel" style=" width:260px">
                        <asp:Label ID="Label2" runat="server" Text="Thời gian:" />
                    </div>
               		<div  class="DivTextBox" >
		            	<asp:TextBox ID="txtFromDate" CssClass="TextBox Date" Width="85px" runat="server" Text="" /> tới ngày:			<asp:TextBox ID="txtToDate" CssClass="TextBox Date" Width="85px" runat="server" Text="" /> <i>dd/MM/yyyy</i>
	            	</div>
                </div>            
            ...
            <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField='TongSoKiemDinh' HeaderText='Tổng TB phải kiểm định'>
                        <ItemStyle Width='8%' />
                    </asp:BoundField>
                    <asp:BoundField DataField='SoTBChuaKiemDinh' HeaderText='Số TB chưa kiểm định'>
                        <ItemStyle Width='8%' />
                    </asp:BoundField>
