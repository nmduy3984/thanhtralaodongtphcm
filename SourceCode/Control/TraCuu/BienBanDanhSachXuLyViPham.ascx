<%@ Control Language="VB" AutoEventWireup="false" CodeFile="BienBanDanhSachXuLyViPham.ascx.vb"
    Inherits="Control_TraCuu_BienBanDanhSachXuLyViPham" %>
...
<asp:UpdatePanel ID="uplDailyDebt" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    <asp:Label ID="lblReportName" runat="server" Text="BIÊN BẢN DANH SÁCH DOANH NGHIỆP XỬ LÝ VI PHẠM" />
                </h3>
            </div>
            ...
            <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField='Col4' HeaderText="Số vi phạm">
                        <ItemStyle  HorizontalAlign="Right" Width='8%' />
                    </asp:BoundField>
                    <asp:BoundField DataField='Col5' HeaderText='Số kiến nghị đã thực hiện'>
                        <ItemStyle HorizontalAlign="Right" Width='8%' />
                    </asp:BoundField>
                    <asp:BoundField DataField='Col6' HeaderText='Số tiền phạt'>
                        <ItemStyle HorizontalAlign="Right" Width='8%' />
                    </asp:BoundField>
                    <asp:BoundField DataField='Col7' HeaderText='Đã nộp phạt'>
                        <ItemStyle HorizontalAlign="Right" Width='8%' />
                    </asp:BoundField>
                </Columns>
