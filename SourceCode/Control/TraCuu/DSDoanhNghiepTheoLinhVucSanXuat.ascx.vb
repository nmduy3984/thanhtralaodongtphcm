...
Partial Class Control_TraCuu_DSDoanhNghiepTheoLinhVucSanXuat
...
#Region "PRIVATE EVENT FOR CONTROL"
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1 _
                            ...
                            , Optional ByVal strLinhVucSXId As Integer = -1 _
        ...
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim p = data.uspTraCuuDSDoanhNghiepTheoLinhVucSanXuat(strTinh, strLinhVucSXId, iPage, intPag_Size).ToList()
            'Tong so ban ghi
