<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DSDNChuaDoMoiTruongLadoDong.ascx.vb"
    Inherits="Control_TraCuu_1_DSDNChuaDoMoiTruongLadoDong" %>
...
<asp:UpdatePanel ID="uplDailyDebt" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    <asp:Label ID="lblReportName" runat="server" Text="Danh sách doanh nghiệp chưa đo môi trường lao động" />
                </h3>
            </div>
            ...
            <div id="SearchCondition" class="Div-Center">
                ...
                <div class="DivRow">
                    ...
                    <div class="DivTextBox">
                        <asp:TextBox ID="txtFromDate" CssClass="TextBox Date" Width="85px" runat="server"
                            Text="" />
                        tới ngày:
                        <asp:TextBox ID="txtToDate" CssClass="TextBox Date" Width="85px" runat="server" Text="" />
                        <i>dd/MM/yyyy</i>
                    </div>
                </div>
                <div class="DivRow" style="display: none">
