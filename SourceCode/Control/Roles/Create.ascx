<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Create.ascx.vb" Inherits="Control_Roles_Create" %>
<div class="BoxField">
    ...
    <div class="DivRow">
        <div class="DivLabel">
            <asp:Label ID="lblTitle" CssClass="TextLabel" runat="server" Text="Tên vai trò:" /><span class="fieldRequired"></span>
        </div>
