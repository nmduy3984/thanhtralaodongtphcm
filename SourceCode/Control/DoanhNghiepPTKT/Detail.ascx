<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Detail.ascx.vb" Inherits="Control_DoanhNghiep_Detail" %>
<div id="view" class="BoxField" runat="server">
    ...
    <div class="DivRow tbl_row_0">
        ...
        <div class="tbl_colRight">
             <asp:Label ID="lkbTendoanhnghiep" CssClass="" runat="server" Text=" " />
        </div>
    </div>
    ...
    <div class="DivRow tbl_row_0">
        <div class="tbl_colLeft">
            <asp:Label ID="Label1" runat="server" Text="Người liên hệ:" />
        </div>
        <div class="tbl_colRight">
