        ...
        Using data As New ThanhTraLaoDongEntities
            ...
            Try
                ...
                Else
                    ...
                    data.SaveChanges()
                End If
                Insert_App_Log("Insert  Doanhnghiep:" & txtTendoanhnghiep.Text.Trim() & "", Function_Name.DoanhNghiepTT, Audit_Type.Create, Request.ServerVariables("REMOTE_ADDR"), Session("UserName"))
