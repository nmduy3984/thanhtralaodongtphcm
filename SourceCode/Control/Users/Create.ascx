<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Create.ascx.vb" Inherits="Control_Users_Create" %>
...
<div class="DivRow">
    ...
    <div class="DivTextBox">
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Vui lòng nhập mật khẩu tối thiểu 6 ký tự!"
            Display="None" ControlToValidate="txtPassword" ValidationExpression="[0-9a-zA-Z]{6,}" />
    </div>
</div>
<div class="DivRow">
    <div class="DivLabel">
...
<div class="DivRow">
    <div class="DivLabel">
        <asp:Label ID="Label1" CssClass="TextLabel" runat="server" Text="Tỉnh:" />
    </div>
    <div class="DivTextBox">
        <asp:DropDownList runat="server" CssClass="DropDownList" ID="ddlTinh" Width="248px">
            
        </asp:DropDownList>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Display="None"
            ControlToValidate="ddlTinh" ErrorMessage="Vui lòng chọn tỉnh"
