<%@ Control Language="VB" AutoEventWireup="false" CodeFile="List.ascx.vb" Inherits="Control_QuanHuyen_List" %>
...
<asp:UpdatePanel ID="uplDonvikinhtehcsn" runat="server">
    <ContentTemplate>
        ...
        <div class="SubjectTitle">
            ...
            <div class="DivRow">
                <div class="DivLabel">
                    <asp:Label ID="lblMota" CssClass="TextLabel" runat="server" Text="Lọc theo mã hoặc tên:" />
                </div>
            ...
            <div class="DivRow">
                <div class="DivLabel">
                    <asp:Label ID="Label134" CssClass="TextLabel" runat="server" Text="Tỉnh/Thành phố:" />
                </div>
                <div class="DivTextBox">
                    <asp:DropDownList ID="ddlTinhTP" runat="server" CssClass="DropDownList"></asp:DropDownList>
                </div>
            </div>

            <div class="DivRow">
                <div class="DivLabel">
                    <asp:Label ID="Label1" CssClass="TextLabel" runat="server" Text="Mức lương:" />
                </div>
                <div class="DivTextBox">
                    <asp:DropDownList ID="ddlMucluong" runat="server" CssClass="DropDownList" ></asp:DropDownList>
                </div>
            </div>
        ...
        <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
            ...
            <Columns>
                ...
                <asp:BoundField DataField='TieuDe' HeaderText='Lương tối thiểu'>
                    <ItemStyle Width='15%' />
                </asp:BoundField>
