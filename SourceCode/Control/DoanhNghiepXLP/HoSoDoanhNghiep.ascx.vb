...
Partial Class Control_DoanhNghiep_HoSoDoanhNghiep
    ...
    Private Sub BindToGrid(Optional ByVal strTinh As Integer = -1, Optional ByVal strYear_From As Integer = 0, Optional ByVal strYear_To As Integer = 0)
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim strKey_name() As String = {"NamDT", "SoLoiDT", "PhieuIdDT", "ThangNamTKT", "PhieuIdTKT", "NamXP", "PhieuIdXP", "NguoiTao"}
            'Tong so ban ghi
    ...
    Protected Sub grdShow_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdShow.RowDataBound
        If e.Row.RowIndex >= 0 Then
            ...
            If Not (grdShow.DataKeys(e.Row.RowIndex)("NguoiTao").ToString().Contains(Session("Username")) _
                ...
                lnkSoLanThanhTra.Enabled = False
                hplSoLoiThanhTra.Enabled = False
                lnkSoLanTuKiemTra.Enabled = False
                hplSoLanXuPhat.Enabled = False

                lnkSoLanThanhTra.Attributes.Add("style", "color:gray !important")
                hplSoLoiThanhTra.Attributes.Add("style", "color:gray !important")
                lnkSoLanTuKiemTra.Attributes.Add("style", "color:gray !important")
                hplSoLanXuPhat.Attributes.Add("style", "color:gray !important")
            End If
        End If
    End Sub
