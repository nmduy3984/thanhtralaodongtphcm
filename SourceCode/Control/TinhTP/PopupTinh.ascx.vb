...
Partial Class Control_TinhTP_PopupTinh
...
#Region "Sub and Function"
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1, Optional ByVal strSearch As String = "")
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim strKey_Name() As String = {"TinhId", "TenTinh"}
            Dim p = data.uspTinhSelectAll(strSearch, iPage, intPag_Size).ToList()
...
#Region "Event for control"
    ...
    Protected Sub grdShow_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdShow.RowDataBound
        If e.Row.RowIndex >= 0 Then
            ...
            e.Row.Attributes.Add("onclick", "return SelectTinh('" & grdShow.DataKeys(e.Row.RowIndex)("TenTinh") & "')")
...
#Region "Search"
    Protected Sub btnFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFilter.Click
        BindToGrid(1, txtTinh.Text.Trim())
    End Sub
#End Region
End Class
