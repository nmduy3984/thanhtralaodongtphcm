...
Partial Class Control_Report_PhanTichTinhHinhViPhamLD1
        ...
        Using data As New ThanhTraLaoDongEntities
            Select Case type
                ...
                Case 2 '' Lấy dữ liệu theo Loại hình sản xuất
                    Dim query = From q In data.LoaiHinhSanXuats
                                Where q.ParentID = Value
                                Order By q.LoaiHinhSXId Ascending
                                Select q
                    Dim dtList = query.ToList()
                    isLevel = isLevel + IIf(dtList.Count >= 0, 1, 0)
                    If isLevel <= 4 Then
...
#Region "PRIVATE EVENT FOR CONTROL"
    Private Sub BindToGrid(Optional ByVal strReportType As String = "", Optional ByVal strReportParams1 As String = "", Optional ByVal strReportParams2 As String = "")
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim p = data.usp_Rpt_PhanTichTinhHinhViPhamLD(strReportType, strReportParams1, strReportParams2, TypeViPham.ViPham, False).ToList
    ...
    Protected Sub grdShow_RowCreated(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles grdShow.RowCreated
        ...
        If e.Row.RowType = DataControlRowType.Header Then
            ...
            Select Case ddlType.SelectedValue
                Case 1
                    headeReport = "Tình hình vi phạm theo loại hình doanh nghiệp".ToUpper()
                Case 2
            ...
            If ddlType.SelectedValue = 2 Or ddlType.SelectedValue = 3 Then
