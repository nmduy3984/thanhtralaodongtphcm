...
#Region "PRIVATE EVENT FOR CONTROL"
    Private Sub BindToGrid(Optional ByVal strTinh As Integer = -1, Optional ByVal strHuyen As Integer = 0, Optional ByVal strKhuCongNghiep As Integer = 0, Optional ByVal strYear_From As Integer = 0, Optional ByVal strYear_To As Integer = 0)
        Using data As New ThanhTraLaoDongEntities
            Dim p = data.usp_Rpt_Phieu_KetQuaThanhTra(strTinh, strHuyen, strKhuCongNghiep, strYear_From, strYear_To).ToList
    ...
    Private Sub Button_Click(ByVal sender As Object, ByVal em As System.EventArgs) Handles btnExport.Click
        ...
        Dim strKhuCongNghiep As Integer = ddlKhuCongNghiep.SelectedValue
        ...
        BindToGrid(strTinh, strHuyen, strKhuCongNghiep, strYear_From, strYear_To)
    End Sub
