...
Partial Class Control_Report_KetQuaThanhTra2
...
#Region "SUB AND FUNCTION"
    ...
    Private Sub LoadData()
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim dtListReport = (From q In data.vLoaiHanhVis
                                 Order By CInt(q.Id)).ToList()
...
#Region "PRIVATE EVENT FOR CONTROL"
    Private Sub BindToGrid(Optional ByVal strReportType As String = "#", Optional ByVal strReportParams As String = "")
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim p = data.usp_Rpt_KetQuaThanhTra2(strReportType, strReportParams).ToList
