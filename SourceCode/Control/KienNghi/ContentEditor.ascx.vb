...
Partial Class Control_KienNghi_ContentEditor
...
#Region "Sub and Function "
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request.PhysicalPath.Contains("List.aspx") Then
                ...
                'Permission
                lbtAdd.Visible = HasPermission(Function_Name.KienNghi, Session("RoleID"), 0, Audit_Type.Create)
            ...
            ElseIf Request.PhysicalPath.Contains("Edit.aspx") Then
                ...
                setPermission()
            End If
            If Not Request.QueryString("KienNghiId") Is Nothing Then
                hidID.Value = Request.QueryString("KienNghiId")
                'Load list action status
                LoadListStatus(hidID.Value)
                'Permission
                btnDelete.Visible = HasPermission(Function_Name.KienNghi, Session("RoleID"), 0, Audit_Type.Delete)
    ...
    Protected Sub setPermission()
        ...
        lbtAdd.Visible = HasPermission(Function_Name.KienNghi, Session("RoleID"), 0, Audit_Type.Create)
        lbtView.Visible = HasPermission(Function_Name.KienNghi, Session("RoleID"), 0, Audit_Type.ViewContent)
        lbtEdit.Visible = HasPermission(Function_Name.KienNghi, Session("RoleID"), 0, Audit_Type.Edit)
        btnDelete.Visible = HasPermission(Function_Name.KienNghi, Session("RoleID"), 0, Audit_Type.Delete)
    End Sub
    ...
    Protected Sub lbtEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtEdit.Click
        Response.Redirect("Edit.aspx?KienNghiId=" & hidID.Value & "")
    End Sub
    Protected Sub lbtView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtView.Click
        Response.Redirect("Detail.aspx?KienNghiId=" & hidID.Value & "")
    End Sub
    Protected Sub lnkbtnDelete_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDelete.Click
        ...
        Using data As New ThanhTraLaoDongEntities
            ...
            Try
                ...
                data.SaveChanges()
                Excute_Javascript("Alertbox('Xóa dữ liệu thành công.');window.location ='../../Page/KienNghi/List.aspx';", Me.Page, True)
