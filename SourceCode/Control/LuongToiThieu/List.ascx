<%@ Control Language="VB" AutoEventWireup="false" CodeFile="List.ascx.vb" Inherits="Control_LuongToiThieu_List" %>
        ...
        <div id="pnlSearch" class="SubjectTitle">
            <div id="search">
                <div class="DivRow">
                    ...
                    <asp:Button ID="btnClear" runat="server" CausesValidation="false" CssClass="btn" Text="Hủy" />
        ...
        <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemStyle CssClass="GridTextLink" HorizontalAlign="Center" Width="8%" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText='Mức lương tối thiểu'>
                    <ItemTemplate>
                        <asp:Label ID="lblMucLuongToiThieu" runat="server"></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width='8%' CssClass='text_list_links' HorizontalAlign='Left' />
                </asp:TemplateField>
                <asp:BoundField DataField="QuyetDinh" HeaderText="Số quyết định" >
                 <ItemStyle Width='12%' />
                </asp:BoundField>
                <asp:BoundField DataField="NgayQuyetDinh" HeaderText="Ngày quyết định" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" >
                 <ItemStyle Width='10%' />
                </asp:BoundField>
                <asp:TemplateField HeaderText='Phạm vi áp dụng'>
                    <ItemTemplate>
                        <asp:Label ID="lblLoainhanuoc" runat="server"></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width='10%' CssClass='text_list_links' HorizontalAlign='Left' />
                </asp:TemplateField>

                <asp:TemplateField HeaderText='Quận Huyện áp dụng'>
                    <ItemTemplate>
                        <asp:HyperLink ID="hplQuanHuyen" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle Width='10%' CssClass='text_list_links' HorizontalAlign='Left' />
                </asp:TemplateField>
