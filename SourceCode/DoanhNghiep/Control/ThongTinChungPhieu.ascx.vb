...
Imports Cls_Common
Partial Class DoanhNghiep_Control_ThongTinChungPhieu
    ...
    Protected Sub ShowData()
        Using data As New ThanhTraLaoDongEntities
            ...
            If p.Count > 0 Then
                ...
                'Else
                '    txtSoQD.Text = "PTKT/xxx/" & Now.Year.ToString & "/" & p(0).KiHieu & "/No"
                'End If
                'lblMadoanhnghiep.Text = IIf(IsNothing(p.MaDoanhNghiep) = True, "", p.MaDoanhNghiep)
                'lblTendoanhnghiep.Text = IIf(IsNothing(p(0).TenDoanhNghiep) = True, "", p(0).TenDoanhNghiep)
...
#Region "Event for control"
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Response.Redirect("../ThongTin.aspx?DNId=" & hidID.Value)
    End Sub
#End Region
End Class
