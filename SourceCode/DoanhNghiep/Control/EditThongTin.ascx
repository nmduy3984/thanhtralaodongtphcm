<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EditThongTin.ascx.vb"
    Inherits="DoanhNghiep_Control_EditThongTin" %>
...
<script type="text/javascript">
    ...
    function ajaxJquery() {
        $(function () {
            //Kiem tra trung
            $("#<%= txtSochungnhandkkd.ClientID %>").focusout(function () {
                var sName = $(this).val();
                $.ajax({
...
<asp:UpdatePanel ID="uplDoanhnghiep1" runat="server">
    <ContentTemplate>
        <div class="BoxField" id="edit">
            ...
            <div class="Div-Left">
                <div class="DivLabelDoanhNghiep">
                    <asp:Label ID="lblNamtllhdn" CssClass="TextLabel" runat="server" Text="Năm thành lập doanh nghiệp:" /><span
                        class="fieldRequired">&nbsp;</span>
                </div>
            ...
            <div class="Div-Right">
                ...
                <cc1:ValidationDropdownlist ID="ddlLoaiHinhDN" runat="server" Style="width: 248px"
                    CssClass='DropDownList' AssociatedLableText="loại hình doanh nghiệp" DataType="required" />
            </div>
            <div class="DivRow">
            </div>
            <div class="Div-Left">
            ...
            <div class="Div-Left">
                ...
                <cc1:ValidationDropdownlist ID="ddlTinh" runat="server" Style="width: 248px" CssClass='DropDownList'
            ...
            <div class="Div-Left">
                ...
                <cc1:ValidationDropdownlist ID="ddlHuyen" runat="server" CssClass='DropDownList'
                    Style="width: 248px" AssociatedLableText="huyện" DataType="required" />
            </div>
            <div class="DivRow">
            </div>
            <div class="Div-Left">
                ...
                <cc2:ValidationTextBox ID="txtKhucongnghiep" runat="server" CssClass='TextBox' />
            </div>
            <div class="DivRow">
            </div>
            <div class="Div-Left">
            ...
            <div class="Div-Left">
                ...
                <cc2:ValidationTextBox ID="txtDienthoai" runat="server" CssClass='TextBox' CustomPattern="CellPhone"
                    DataType="custom" AssociatedLableText="điện thoại" />
            </div>
            <div class="Div-Left">
                <div class="DivLabelDoanhNghiep">
            ...
            <div class="Div-Left">
                ...
                <cc2:ValidationTextBox ID="txtNgaythaydoi" runat="server" CssClass='TextBox Date'
                    CompareData="Date" CompareOperator="GreaterThanEqual" CompareTo="txtNgaychungnhandkkd"
                    AssociatedLableText="Ngày thay đổi giấy ĐKKD" />(dd/mm/yyyy)
            </div>
            <div class="DivRow">
            </div>
            <div class="Div-Left">
...
" />
            ...
            <div class="Div-Left">
                ...
                <cc2:ValidationTextBox ID="txtSolaodongnu" runat="server" CssClass='TextBox ToolTip' AssociatedLableText="Nếu không có nữ nhập số 0"
                    DataType="requiredAndInteger" />
            </div>
            <div class="Div-Left">
                <div class="DivLabelDoanhNghiep">
            ...
            <div class="Div-Left">
                ...
                <cc2:ValidationTextBox ID="txtTonggiatrisp" runat="server" CssClass='TextBox' AssociatedLableText="tổng giá trị sản phẩm"
                    DataType="numeric" Style="width: 185px;" />(tỷ đồng)
            </div>
            <div class="Div-Left">
                <div class="DivLabelDoanhNghiep">
                    <asp:Label ID="Label6" CssClass="TextLabel" runat="server" Text="Tổng lợi nhuận sau thuế:" />
                </div>
            ...
            <div class="Div-Left">
                ...
                <div class="Child DivTextBox ">
                    <asp:CheckBoxList ID="chkIsCongDoan" CssClass="checkbox" runat="server" RepeatDirection="Horizontal"
                        Width="200px">
            ...
            <div class="Div-Left">
                <div class="DivLabelDoanhNghiep">
                    <asp:Label ID="Label4" CssClass="TextLabel" runat="server" Text="Người liên hệ(phụ trách Nhân sự hoặc An toàn):" />
                </div>
