...
#Region "PRIVATE EVENT FOR CONTROL"
    Private Sub BindToGrid(Optional ByVal strSoQD As String = "#",
                           ...
                           Optional ByVal strKhuCongNghiepID As String = "0",
        ...
        Try
            Using data As New ThanhTraLaoDongEntities
                ...
                Using cmdReport
                    ...
                    Dim parameter6 As SqlParameter = New SqlParameter("@MaKhuCongNghiep", strKhuCongNghiepID)
                    cmdReport.Parameters.Add(parameter6)
    ...
    Private Sub Button_Click(ByVal sender As Object, ByVal em As System.EventArgs) Handles btnExport.Click, btnExportExcel.Click, btnBCTong.Click
        Select Case CType(sender, Control).ID
            Case "btnExport"
                ...
                Dim khucongnghiep = ddlKhuCongNghiep.SelectedValue
                ...
                BindToGrid(strSoQD, tinh, huyen, khucongnghiep, iLoaiNguoiDung, StrViPhamParam)
            Case "btnExportExcel"
                ExportExcel()
            Case "btnBCTong"
                Dim strSoQD = ddlSoQuyetDinh.SelectedValue.ToString()
                ...
                BindToGrid(strSoQD, tinh, huyen, khucongnghiep, iLoaiNguoiDung, StrViPhamParam, True)
        End Select
    ...
    Private Sub ExportExcel(Optional ByVal IsBCTong As Boolean = False)
        Using data As New ThanhTraLaoDongEntities
            ...
            Using cmdReport
                ...
                cmdReport.Parameters.Add(parameter5)
                Dim parameter6 As SqlParameter = New SqlParameter("@MaKhuCongNghiep", khucongnghiep)
                cmdReport.Parameters.Add(parameter6)
