...
Partial Class Control_Function_ContentEditor
...
#Region "Sub and Function "
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request.PhysicalPath.Contains("List.aspx") Then
                ...
                'Permission
                lbtAdd.Visible = HasPermission(Function_Name.FunctionSys, Session("RoleID"), 0, Audit_Type.Create)
            ...
            ElseIf Request.PhysicalPath.Contains("Edit.aspx") Then
                ...
                setPermission()
            End If
            If Not Request.QueryString("FuncId") Is Nothing Then
                hidID.Value = Request.QueryString("FuncId")
                'Load list action status
                'LoadListStatus(hidID.Value)
                'Permission
                btnDelete.Visible = HasPermission(Function_Name.FunctionSys, Session("RoleID"), 0, Audit_Type.Delete)
    ...
    Protected Sub setPermission()
        ...
        lbtAdd.Visible = HasPermission(Function_Name.FunctionSys, Session("RoleID"), 0, Audit_Type.Create)
        lbtView.Visible = HasPermission(Function_Name.FunctionSys, Session("RoleID"), 0, Audit_Type.ViewContent)
        lbtEdit.Visible = HasPermission(Function_Name.FunctionSys, Session("RoleID"), 0, Audit_Type.Edit)
        btnDelete.Visible = HasPermission(Function_Name.FunctionSys, Session("RoleID"), 0, Audit_Type.Delete)
    End Sub
    ...
    Protected Sub lnkbtnDelete_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDelete.Click
        ...
        Using data As New ThanhTraLaoDongEntities
            ...
            Try
                ...
                Excute_Javascript("Alertbox('Xóa dữ liệu thành công.');window.location ='../../Page/Function/List.aspx';", Me.Page, True)
