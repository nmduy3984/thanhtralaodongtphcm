...
#Region "Sub and Function "
    ...
    Protected Sub setPermission()
        lbtAdd.Visible = HasPermission(Function_Name.DoanhNghiepPTKT, Session("RoleID"), 0, Audit_Type.Create)
        lbtView.Visible = HasPermission(Function_Name.DoanhNghiepPTKT, Session("RoleID"), 0, Audit_Type.ViewContent)
        lbtEdit.Visible = HasPermission(Function_Name.DoanhNghiepPTKT, Session("RoleID"), 0, Audit_Type.Edit)
        btnDelete.Visible = HasPermission(Function_Name.DoanhNghiepPTKT, Session("RoleID"), 0, Audit_Type.Delete)
    End Sub
