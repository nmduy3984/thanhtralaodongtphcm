            ...
            If Not IsNothing(p) Then
                Try
                    ...
                    If Not IsNothing(Session("EditInfoPhieu")) Then
                        ...
                        Insert_App_Log("Update  Doanhnghiep:" & txtTendoanhnghiep.Text.Trim() & "", Function_Name.DoanhNghiepPTKT, Audit_Type.Edit, Request.ServerVariables("REMOTE_ADDR"), Session("UserName"))
