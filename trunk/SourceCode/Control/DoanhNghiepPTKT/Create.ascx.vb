    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Not Session("Username") = "" Then
                ...
                End If
                'Kiểm tra khi đã tạo mới cho tạo phiếu luôn không về trang List
        ...
        Using data As New ThanhTraLaoDongEntities
            ...
            Try
                ...
                Else
                    ...
                    Session("DoanhNghiepIdCreate") = p.DoanhNghiepId
                End If
                Insert_App_Log("Insert  Doanhnghiep:" & txtTendoanhnghiep.Text.Trim() & "", Function_Name.DoanhNghiepPTKT, Audit_Type.Create, Request.ServerVariables("REMOTE_ADDR"), Session("UserName"))
