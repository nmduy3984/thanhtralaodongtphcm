...
Partial Class Control_LoaiHinhSanXuat_Create
...
#Region "Sub and Function "
    ...
    Protected Function CheckExist(ByVal strCode As String) As Boolean
        Using data As New ThanhTraLaoDongEntities
            Dim p As LoaiHinhSanXuat = (From q In data.LoaiHinhSanXuats Where q.Code.Equals(strCode) Select q).SingleOrDefault
...
#Region "Event for control "
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            Using data As New ThanhTraLaoDongEntities
                Dim p As New ThanhTraLaoDongModel.LoaiHinhSanXuat
                Try
                    ...
                    data.LoaiHinhSanXuats.AddObject(p)
                    data.SaveChanges()
                    Insert_App_Log("Insert  Loai hinh san xuat:" & txtTitle.Text.Trim & "", Function_Name.LoaiHinhSanXuat, Audit_Type.Create, Request.ServerVariables("REMOTE_ADDR"), Session("UserName"))
