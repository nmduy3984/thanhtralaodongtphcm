...
Partial Class Control_LoaiHinhSanXuat_List
...
#Region "Sub and Function"
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1, Optional ByVal strSearch As String = "")
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim strKey_Name() As String = {"LoaiHinhSXId", "Title", "Code"}
...
#Region "Event for control"
    ...
    Protected Sub grdShow_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdShow.RowDataBound
        If e.Row.RowIndex >= 0 Then
            ...
            hplEdit.NavigateUrl = "../../Page/LoaiHinhSanXuat/Edit.aspx?LoaiHinhSXId=" & grdShow.DataKeys(e.Row.RowIndex)("LoaiHinhSXId").ToString
            Dim hplCode As HyperLink = CType(e.Row.FindControl("hplCode"), HyperLink)
            hplCode.NavigateUrl = "../../Page/LoaiHinhSanXuat/Detail.aspx?LoaiHinhSXId=" & grdShow.DataKeys(e.Row.RowIndex)("LoaiHinhSXId").ToString
            ...
            'Permission
            hplEdit.Enabled = HasPermission(Function_Name.LoaiHinhSanXuat, Session("RoleID"), 0, Audit_Type.Edit)
            If HasPermission(Function_Name.LoaiHinhSanXuat, Session("RoleID"), 0, Audit_Type.Delete) = True Then
