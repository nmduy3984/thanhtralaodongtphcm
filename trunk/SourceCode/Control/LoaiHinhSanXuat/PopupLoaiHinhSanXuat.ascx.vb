...
Partial Class Control_LoaiHinhSanXuat_PopupLoaiHinhSanXuat
...
#Region "Sub and Function"
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1, Optional ByVal strSearch As String = "")
        Using data As New ThanhTraLaoDongEntities
            Dim arrSearch() As String = {iPage, strSearch}
            ViewState("search") = arrSearch

            'So ban ghi muon the hien tren trang
            Dim intPag_Size As Int32 = drpPage_Size.SelectedValue
            Dim strKey_Name() As String = {"LoaiHinhSXId", "Title"}
            Dim p = data.uspLoaiHinhSanXuatSelectAll(strSearch, iPage, intPag_Size).ToList()
...
#Region "Event for control"
    ...
    Protected Sub grdShow_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdShow.RowDataBound
        If e.Row.RowIndex >= 0 Then
            Dim key As String = e.Row.RowIndex
            e.Row.Attributes.Add("id", key)
            e.Row.Attributes.Add("onclick", "return SelectLoaiHinhSanXuat('" & grdShow.DataKeys(e.Row.RowIndex)("LoaiHinhSXId") & "','" & grdShow.DataKeys(e.Row.RowIndex)("Title") & "')")
            Dim chkItem As RadioButton = CType(e.Row.FindControl("chkItem"), RadioButton)
            chkItem.Attributes.Add("onclick", "return SelectLoaiHinhSanXuat('" & grdShow.DataKeys(e.Row.RowIndex)("LoaiHinhSXId") & "','" & grdShow.DataKeys(e.Row.RowIndex)("Title") & "')")
...
#Region "Search"
    Protected Sub btnFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFilter.Click
        BindToGrid(1, txtLHSX.Text.Trim())
    End Sub
#End Region
End Class
