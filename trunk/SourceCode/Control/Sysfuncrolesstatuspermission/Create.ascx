<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Create.ascx.vb" Inherits="Control_Sysfuncrolesstatuspermission_Create" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>


<div  class="BoxField">
<div class="HeadTitle"><h3>THÊM MỚI VAI TRÒ - CHỨC NĂNG</h3>
<span class="fieldRequired">&nbsp;</span>Trường yêu cầu nhập dữ liệu
     ...
     <div class="Error">
        ...
        <div class="DivRow">
		    ...
		    <div>
                <asp:DropDownList ID="ddlFunctionID" runat="server" CssClass="TextBox" 
                    AutoPostBack="True">
                </asp:DropDownList>
...
<asp:HiddenField ID="hidStatus" Value="0" runat="server" /></div>
