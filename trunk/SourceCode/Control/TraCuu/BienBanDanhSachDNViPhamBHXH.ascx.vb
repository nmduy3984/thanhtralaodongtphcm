...
Partial Class Control_TraCuu_BienBanDanhSachDNViPhamBHXH
...
#Region "PRIVATE EVENT FOR CONTROL"
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1 _
                               ...
                               , Optional ByVal strYearTo As Integer = 9999)
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim p = data.uspBienBanDanhSachDN_VPBHXH(strTinh, strYearFrom, strYearTo, iPage, intPag_Size).ToList()
