...
Partial Class Control_TraCuu_DSDNChuaHuanLuyenLaoDong
...
#Region "PRIVATE EVENT FOR CONTROL"
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1 _
        ...
        Using data As New ThanhTraLaoDongEntities
            ...
            Dim p = data.uspTraCuuDSDNChuaHuanLuyenAnToanLaoDong(strTinh, strFromDate, strToDate, iPage, intPag_Size).ToList()
            'Tong so ban ghi
