<%@ Control Language="VB" AutoEventWireup="false" CodeFile="BienBanDanhSachDNCoYTNHDH.ascx.vb" Inherits="Control_TraCuu_BienBanDanhSachDNCoYTNHDH" %>
...
<asp:UpdatePanel ID="uplDailyDebt" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    <asp:Label ID="lblReportName" runat="server" Text="BIÊN BẢN DANH SÁCH DOANH NGHIỆP CÓ YẾU TỐ NGUY HIỂM ĐỘC HẠI" />
                </h3>
            </div>
             ...
             <div class="DivRow">
                ...
                <div class="DivRow">
                    ...
                    <div class="DivTextBox">
                        ...
                        <asp:RadioButtonList ID="rptCoYTNHDH" runat="server" 
            ...
            <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField='Col5' HeaderText="Số lao động NH,DH">
                        <ItemStyle HorizontalAlign="Right" Width='10%' />
                    </asp:BoundField>
                    <asp:BoundField DataField='Col6' HeaderText="Số vụ TNLĐ">
                        <ItemStyle HorizontalAlign="Right" Width='10%' />
                    </asp:BoundField>
                    <asp:BoundField DataField='Col7' HeaderText='Số người chết'>
                        <ItemStyle HorizontalAlign="Right" Width='10%' />
                    </asp:BoundField>
                </Columns>
