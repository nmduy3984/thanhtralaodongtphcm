<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DSDNChuaHuanLuyenAnToanLaoDong.ascx.vb" Inherits="Control_TraCuu_DSDNChuaHuanLuyenLaoDong" %>
...
<asp:UpdatePanel ID="uplDailyDebt" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>                    
                    <asp:Label ID="lblReportName" runat="server" Text="Danh sách doanh nghiệp chưa huấn luyện an toàn lao động" />
                </h3>
            </div>
            ...
            <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField='SoDinhKyThieu' HeaderText='Số người chưa huấn luyện'>
                        <ItemStyle Width='10%' />
                    </asp:BoundField>
