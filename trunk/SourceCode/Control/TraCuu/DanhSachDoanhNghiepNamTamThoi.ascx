<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DanhSachDoanhNghiepNamTamThoi.ascx.vb" Inherits="Control_TraCuu_DanhSachDoanhNghiepNamTamThoi" %>
        ...
        <div class="BoxField">
            ...
            <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField='Col3' HeaderText='Người liên hệ'>
                        <ItemStyle Width='20%' />
                    </asp:BoundField>
                    <asp:BoundField DataField='Col3' HeaderText='Lĩnh vực'>
                        <ItemStyle Width='20%' />
                    </asp:BoundField>

                    <asp:BoundField DataField='Col3' HeaderText='Địa chỉ email'>
                        <ItemStyle Width='10%' />
                    </asp:BoundField>
