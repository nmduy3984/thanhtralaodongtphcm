<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DSKienNghiCuaDoanhNghiepNam.ascx.vb" Inherits="Control_TraCuu_DSKienNghiCuaDoanhNghiepNam" %>
...
<asp:UpdatePanel ID="uplDailyDebt" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>                    
                    <asp:Label ID="lblReportName" runat="server" Text="Danh sách kiến nghị doanh nghiệp" />
                </h3>
            </div>
            ...
            <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField='TenDoanhNghiep' HeaderText="Tên doanh nghiệp có kiến nghị">
                        <ItemStyle Width='40%' />
                    </asp:BoundField>
