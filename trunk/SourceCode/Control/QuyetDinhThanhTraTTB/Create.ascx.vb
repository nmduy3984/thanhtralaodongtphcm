...
#Region "Sub and Function "
    ...
    Protected Sub LoadData()
        Using data As New ThanhTraLaoDongEntities
            ...
            'Căn cứ quyết định
            txtCancuquyetdinh.Text = "Căn cứ Quyết định số 1288/QĐ-UB ngày 28 tháng 3 năm 2007 của Ủy ban nhân dân thành phố Hồ Chí Minh về thành lập Thanh tra Sở Lao động Thương binh và Xã hội trực thuộc Sở Lao động Thương binh và Xã hội;" + Environment.NewLine
            txtCancuquyetdinh.Text += "Căn cứ chương trình kế hoạch thanh tra năm " & Now.Year.ToString & " đã được Giám đốc Sở Lao động – Thương binh và Xã hội thành phố Hồ Chí Minh phê duyệt,"
