...
#Region "Event for control"
    ...
    Protected Sub grdShow_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdShow.RowDataBound
        If e.Row.RowIndex >= 0 Then
            ...
            hplEdit.NavigateUrl = "../../Page/QuyetdinhthanhtraTTS/Edit.aspx?SoQuyetDinh=" & grdShow.DataKeys(e.Row.RowIndex)("SoQuyetDinh").ToString
            Dim hplSoQuyetDinh As HyperLink = CType(e.Row.FindControl("hplSoQuyetDinh"), HyperLink)
            hplSoQuyetDinh.NavigateUrl = "../../Page/QuyetdinhthanhtraTTS/Detail.aspx?SoQuyetDinh=" & grdShow.DataKeys(e.Row.RowIndex)("SoQuyetDinh").ToString
