<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Create.ascx.vb" Inherits="Control_QuyetDinhThanhTra_Create" %>
...
<script type="text/javascript">
    function ajaxJquery() {
        $(function () {
            ...
            SetNoiNhan($("#<%=ddlChucDanhNguoiKy.ClientID %> option:first"));
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.d.length > 0) {
                    ...
                    var tr = "<tr class='GridRow'><td align='center'><input type='text' class='TextBox' style='width: 350px' /></td><td align='center'><input type='text' class='TextBox' style='width: 260px' /></td>";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.d.length > 0) {
                    for (i = 0; i < data.d.length; i++) {
                        if (data.d[i].ID.trim().length > 0) {
                            //if ((indexCM * 1) == (data.d[i].ID * 1)) {
                            //                                tdcol1 += "<option value='" + data.d[i].ID + "' selected='selected'>" + data.d[i].FullText + "</option>";
                            //                            } else {
    ...
    <ContentTemplate>
        <div class="BoxField">
            <div style="display: block;">
                <div class="HeadTitle">
                    <h3>
                        <asp:Label ID="Label3" runat="server" Text="TẠO QUYẾT ĐỊNH THANH TRA" /></h3>
                </div>
                ...
                <div class="DivRow">
                    <div class="DivLabel">
                        <asp:Label ID="lblChucdanhnguoiky" CssClass="TextLabel" runat="server" Text="Chức danh người kí:" />
                    </div>
                    <div class="fl">
            ...
            <div class="DivRow">
                <div id="DivTextBox"  style="padding-left:10px">
            ...
            <div class="DivRow">
                ...
                <div class="DivTextBox" style="float: right;padding-right:34px">
                    <a id="A4" class="hplDoanhNghiep" style="color: #005EDB; cursor: pointer; margin-right: 10px"
                    ...
                    <div style="float: left">
                        ...
                        &nbsp;<asp:Button ID="btnInQuyetDinh" runat="server" CausesValidation="false" CssClass="btn"
                            Text="In Quyết Định" />&nbsp;<asp:Button ID="btnInDSDoanhNghiep" runat="server" CausesValidation="false"
                                CssClass="btn" Text="In Doanh Nghiệp" />&nbsp;<%--<asp:Button ID="btnReset" runat="server"
                                    CausesValidation="false" CssClass="btn" Text="Làm lại" />--%></div>
