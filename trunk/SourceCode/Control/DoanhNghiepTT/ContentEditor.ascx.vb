...
#Region "Sub and Function "
    ...
    Protected Sub setPermission()
        lbtView.Visible = HasPermission(Function_Name.DoanhNghiepTT, Session("RoleID"), 0, Audit_Type.ViewContent)
        lbtEdit.Visible = HasPermission(Function_Name.DoanhNghiepTT, Session("RoleID"), 0, Audit_Type.Edit)
        btnDelete.Visible = HasPermission(Function_Name.DoanhNghiepTT, Session("RoleID"), 0, Audit_Type.Delete)
    End Sub
                ...
                If isUser = UserType.Admin Or UserName = dn.NguoiTao Then '' Có quyền Xóa
                    ...
                    Try
                        ...
                        If pn.Count = 0 Then
                            ...
                            data.SaveChanges()
                            Insert_App_Log("Delete Doanh Nghiep:" & intId & "", Function_Name.DoanhNghiepTT, Audit_Type.Delete, Request.ServerVariables("REMOTE_ADDR"), Session("UserName"))
                            Excute_Javascript("Alertbox('Xóa dữ liệu thành công.');window.location ='../../Page/DoanhNghiepTT/List.aspx';", Me.Page, True)
                        Else
