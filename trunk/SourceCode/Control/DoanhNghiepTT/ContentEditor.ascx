<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ContentEditor.ascx.vb" Inherits="Control_DoanhNghiep_ContentEditor" %>
    ...
    <div class="rowmain_780">
	    <div class="tabs_manage">
		    <ul>
                ...
                <li><asp:LinkButton ID="lbtBBTT" CausesValidation="false" runat="server"><span>Tạo mới Biên bản thanh tra</span></asp:LinkButton></li>
		    </ul>
