...
#Region "Event for control"
    ...
    Protected Sub grdShow_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdShow.RowDataBound
        If e.Row.RowIndex >= 0 Then
            ...
            hplHoSoDN.NavigateUrl = "../../Page/DoanhNghiepTT/HoSoDoanhNghiep.aspx?DNId=" & grdShow.DataKeys(e.Row.RowIndex)("DoanhNghiepId")
            'Permission
            ...
            'Permission
            Dim permissiondel As Boolean = HasPermission(Function_Name.DoanhNghiepTT, Session("RoleID"), 0, Audit_Type.Delete)
            ...
            End If
            Dim permissionedit As Boolean = HasPermission(Function_Name.DoanhNghiepTT, Session("RoleID"), 0, Audit_Type.Edit)
            If (Not policy Is Nothing AndAlso policy = "1") Or
                (Not policy Is Nothing AndAlso Not policy = "1" And permissionedit) Then
                hplEdit.Enabled = True
                hplEdit.NavigateUrl = "../../Page/DoanhNghiepTT/Edit.aspx?DNId=" & grdShow.DataKeys(e.Row.RowIndex)("DoanhNghiepId")
            ...
            hplTenDN.NavigateUrl = "../../Page/DoanhNghiepTT/Detail.aspx?DNId=" & grdShow.DataKeys(e.Row.RowIndex)("DoanhNghiepId")
            'Permission
            hplTenDN.Enabled = HasPermission(Function_Name.DoanhNghiepTT, Session("RoleID"), 0, Audit_Type.ViewContent)
