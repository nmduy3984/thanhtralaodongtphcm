<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Detail.ascx.vb" Inherits="Control_KhuCongNghiep_Detail" %>
<div id="view" class="BoxField" runat="server">
    ...
    <div class="DivRow tbl_row_1">
        <div class="tbl_colLeft">
            <asp:Label ID="lblTitle_detail" runat="server" Text="Tên khu công nghiệp:" />
        </div>
