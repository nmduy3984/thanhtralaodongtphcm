<%@ Control Language="VB" AutoEventWireup="false" CodeFile="List.ascx.vb" Inherits="Control_TinhTP_List" %>
    ...
    <ContentTemplate>
        ...
        <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
            ...
            <Columns>
                ...
                <asp:BoundField DataField='TenSo' HeaderText='Tên sở'>
                    <ItemStyle Width='15%' />
                </asp:BoundField>
                <asp:BoundField DataField='MoTa' HeaderText='Địa chỉ'>
                    <ItemStyle Width='15%' />
                </asp:BoundField>
                <asp:BoundField DataField='DienThoai' HeaderText='Điện thoại'>
                    <ItemStyle Width='10%' />
                </asp:BoundField>
                <asp:BoundField DataField='KiHieu' HeaderText='Ký hiệu'>
                    <ItemStyle Width='10%' />
                </asp:BoundField>
