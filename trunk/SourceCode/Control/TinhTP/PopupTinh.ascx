<%@ Control Language="VB" AutoEventWireup="false" CodeFile="PopupTinh.ascx.vb" Inherits="Control_TinhTP_PopupTinh" %>
<script type='text/javascript'>
    ...
    function SelectTinh(TenTinh) {
        window.parent.SetTenTinh(TenTinh);
...
<asp:UpdatePanel ID="uplContents" runat="server">
    <ContentTemplate>
        <div class="BoxField" style="background-color: #ffffff; padding-top: 8px;" id="frmSearch">
            <div class="DivRow">
                <div class="DivLabel">
                    <asp:Label ID="lblGroupname" CssClass="TextLabel" runat="server" Text="Nhập tên tỉnh: " />
                </div>
                <div class="DivTextBox">
                    <asp:TextBox ID="txtTinh" CssClass="TextBox" runat="server" Text="" Width="208px" />
                ...
                <asp:GridView ID="grdShow" runat="server" AutoGenerateColumns="False" EmptyDataText="{Không có dữ liệu}"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField='RowNum' HeaderText=' STT '>
                         ...
                         <asp:BoundField DataField='TinhId' HeaderText='Mã tỉnh' Visible="false">
                            <ItemStyle Width='10%' />
                        </asp:BoundField>
                        <asp:BoundField DataField='TenTinh' HeaderText='Tên tỉnh'>
                            <ItemStyle Width='25%' />
                        </asp:BoundField>
