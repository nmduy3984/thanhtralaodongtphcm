<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb" Inherits="Control_KienNghi_Editor" %>
...
<asp:UpdatePanel ID="uplDanhmuchanhvi" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    <asp:Label ID="Label3" runat="server" Text="CHỈNH SỬA KIẾN NGHỊ" /></h3>
            </div>
            ...
            <div class="DivRow">
                ...
                <div class="DivTextBox">
                    <asp:TextBox ID="txtMota" runat="server" CssClass='TextBox LargeTextarea' Height="40px"
