<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb" Inherits="Control_QuanHuyen_Edit" %>
...
<asp:UpdatePanel ID="uplYtgchanthuong" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    <asp:Label ID="Label3" runat="server" Text="CẬP NHẬT QUẬN-HUYỆN" /></h3>
            </div>
            ...
            <div class="DivRow">
                ...
                <div class="DivTextBox">
                    <cc2:ValidationDropdownlist ID="ddlLuongToiThieu" runat="server" CssClass='DropDownList'
