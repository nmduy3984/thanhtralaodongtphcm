...
#Region "Sub and Function"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Not Request("LuongToiThieuID") Is Nothing Then
                BindToGrid(1, "", Request("LuongToiThieuID"))
            Else
                BindToGrid()
            End If
    ...
    Private Sub BindToGrid(Optional ByVal iPage As Integer = 1, Optional ByVal strSearch As String = "", Optional ByVal _LuongToiThieuID As Integer = 0, Optional ByVal _TinhId As Integer = 0)
        Using data As New ThanhTraLaoDongEntities
...
#Region "Search"
    ...
    Protected Sub btnFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFilter.Click
        BindToGrid(1, txtTitleFilter.Text.Trim(), ddlMucluong.SelectedValue, ddlTinhTP.SelectedValue)
    End Sub
