<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UserMenu.ascx.vb" Inherits="Control_Users_UserMenu" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="BoxField">
            <div class="HeadTitle">
                <h3>
                    THÊM MỚI NGƯỜI DÙNG - NHÁNH TIN</h3>
                <span class="fieldRequired">&nbsp;</span>Trường yêu cầu nhập dữ liệu
            </div>
            <div class="Error">
                <asp:ValidationSummary ID="ValidationSummary1" runat="server" />
            </div>
            <div class="DivRow" style="float:left; margin-right:30px" >
                <div class="DivLabel">
                    <asp:Label ID="Label2" CssClass="TextLabel" runat="server" Text="Người dùng:" /><span
                        class="fieldRequired">&nbsp;</span><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlUserID"
                            Display="None" ErrorMessage="Vui lòng chọn người dùng." InitialValue="0">*</asp:RequiredFieldValidator>
                  
                </div>
                <div class="DivTextBox" >
                    <asp:ListBox ID="ddlUserID"  Height="250px" runat="server" CssClass="TextBox"
                        AutoPostBack="True">
                    </asp:ListBox>
            ...
            <div class="DivRow"  style="float:left" >
                <div class="DivLabel">
                    <asp:Label ID="lblAuditnumber" CssClass="TextLabel" runat="server" Text="Nhánh tin:" /><span
                        class="fieldRequired">&nbsp;</span>
                    <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="ClientValidate"
                        ErrorMessage="Vui lòng chọn ít nhất một nhánh tin." Display="None" OnServerValidate="CustomValidator1_ServerValidate">*</asp:CustomValidator>
                </div>
                <div class="DivTextBox">
