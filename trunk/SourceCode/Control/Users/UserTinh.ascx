<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UserTinh.ascx.vb" Inherits="Control_Users_UserTinh" %>
    ...
    <ContentTemplate>
        <div class="BoxField">
            ...
            <div   style="float:left" >
                <div class="DivLabel">
                    <asp:Label ID="lblAuditnumber" CssClass="TextLabel" runat="server" Text="Tỉnh thành:" /><span
                        class="fieldRequired">&nbsp;</span>
                    <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="ClientValidate"
                        ErrorMessage="Vui lòng chọn ít nhất một tỉnh thành." Display="None" OnServerValidate="CustomValidator1_ServerValidate">*</asp:CustomValidator>
                </div><br />
                <div class="DivTextBox">
