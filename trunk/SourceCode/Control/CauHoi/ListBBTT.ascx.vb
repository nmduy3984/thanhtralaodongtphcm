...
Partial Class Control_CauHoi_ListBBTT
...
#Region "Event for control"
    ...
    Protected Sub grdShow_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdShow.RowDataBound
        If e.Row.RowIndex >= 0 Then
            ...
            'Permission
            Dim permissiondel As Boolean = HasPermission(Function_Name.BienBanThanhTra, Session("RoleID"), 0, Audit_Type.Delete)
            ...
            End If
            Dim permissionedit As Boolean = HasPermission(Function_Name.BienBanThanhTra, Session("RoleID"), 0, Audit_Type.Edit)
            If (Not policy Is Nothing AndAlso policy = "1") Or
            ...
            'Permission
            lnkTenphieu.Enabled = HasPermission(Function_Name.BienBanThanhTra, Session("RoleID"), 0, Audit_Type.ViewContent)
            'Link tenphieu
