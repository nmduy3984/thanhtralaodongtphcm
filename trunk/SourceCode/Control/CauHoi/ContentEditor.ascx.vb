...
Partial Class Control_CauHoi_ContentEditor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                Excute_Javascript("AlertboxRedirect('Hãy chọn doanh nghiệp trước.','../../Page/DoanhNghiep/List.aspx');", Me.Page, True)
            ...
            ElseIf Request.PhysicalPath.Contains("CauHoi9") Then
                ...
                'ElseIf Request.PhysicalPath.Contains("YKienDoanhNghiep") Then
                '    lbtYKienDN.CssClass = "current_manage"
                '    lbtYKienDN.Text = "<span class=""current_manage"">Ý kiến doanh nghiệp</span>"
            Else
    ...
    Protected Sub LinkButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtPhieuNhap.Click, lbtCau1.Click, lbtCau2.Click, lbtCau3.Click, lbtCau4.Click,
            lbtCau5.Click, lbtCau6.Click, lbtCau7.Click, lbtCau8.Click, lbtCau9.Click, lbtCau10.Click, lbtCau11.Click, lbtCau12.Click ', lbtYKienDN.Click
        Try
