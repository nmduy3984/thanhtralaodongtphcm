...
Partial Class Control_LoaiHinhDoanhNghiep_Create
...
#Region "Sub and Function "
    ...
    Protected Function CheckExist(ByVal strTitle As String) As Boolean
        Using data As New ThanhTraLaoDongEntities
            Dim p As LoaiHinhDoanhNghiep = (From q In data.LoaiHinhDoanhNghieps Where q.TenLoaiHinhDN.Equals(strTitle) Select q).SingleOrDefault
...
#Region "Event for control "
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If CheckExist(txtTitle.Text.Trim) Then
            Excute_Javascript("Alertbox('Loại hình doanh nghiệp đã tồn tại.');", Me.Page, True)
        Else

            Using data As New ThanhTraLaoDongEntities
                Dim p As New ThanhTraLaoDongModel.LoaiHinhDoanhNghiep
                Try
                    ...
                    data.LoaiHinhDoanhNghieps.AddObject(p)
                    data.SaveChanges()
