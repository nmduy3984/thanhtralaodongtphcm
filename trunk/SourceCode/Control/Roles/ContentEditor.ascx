<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ContentEditor.ascx.vb" Inherits="Control_Roles_ContentEditor" %>
...
</div><asp:HiddenField ID="hidID" Value="0" runat="server" />