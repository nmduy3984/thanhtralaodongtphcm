<%@ Control Language="VB" AutoEventWireup="false" CodeFile="List.ascx.vb" Inherits="Control_Roles_List" %>
...
<ContentTemplate>
	<div class="HeadTitle"><h3>QUẢN LÝ VAI TRÒ</h3></div><div class="SubjectTitle" >Lọc theo vai trò: <asp:TextBox ID="txtTitleFilter" runat="server" CssClass='TextBox'></asp:TextBox><asp:Button ID="btnFilter" runat="server" Text='Lọc' CssClass='btn' /></div>
	...
	<asp:TemplateField HeaderText="STT">
		 ...
		 <asp:TemplateField HeaderText='Vai trò'>
		  <ItemTemplate>
